...
contract LibHandleOperandHandleOperandM1M1Test is Test {
    ...
    function testHandleOperandM1M1NoValues() external pure {
        assertEq(Operand.unwrap(LibHandleOperand.handleOperandM1M1(new uint256[](0))), 0);
    }
    ...
    function testHandleOperandM1M1OneValue(uint256 value) external pure {
        ...
        values[0] = value;
        assertEq(Operand.unwrap(LibHandleOperand.handleOperandM1M1(values)), value);
    }
    ...
    function testHandleOperandM1M1OneValueTooLarge(uint256 value) external {
        ...
        LibHandleOperand.handleOperandM1M1(values);
    }
    ...
    function testHandleOperandM1M1TwoValues(uint256 a, uint256 b) external pure {
        ...
        values[0] = a;
        values[1] = b;
        assertEq(Operand.unwrap(LibHandleOperand.handleOperandM1M1(values)), (b << 1) | a);
    }
