...
contract LibHandleOperandHandleOperand8M1M1Test is Test {
    ...
    function testHandleOperand8M1M1NoValues() external {
        ...
        LibHandleOperand.handleOperand8M1M1(new uint256[](0));
    }
    ...
    function testHandleOperand8M1M1FirstValueOnly(uint256 value) external pure {
        ...
        values[0] = value;
        assertEq(Operand.unwrap(LibHandleOperand.handleOperand8M1M1(values)), value);
    }
    ...
    function testHandleOperand8M1M1FirstValueTooLarge(uint256 value) external {
        ...
        LibHandleOperand.handleOperand8M1M1(values);
    }
    ...
    function testHandleOperand8M1M1FirstAndSecondValue(uint256 a, uint256 b) external pure {
        ...
        values[0] = a;
        values[1] = b;
        assertEq(Operand.unwrap(LibHandleOperand.handleOperand8M1M1(values)), (b << 8) | a);
    }
    ...
    function testHandleOperand8M1M1AllValues(uint256 a, uint256 b, uint256 c) external pure {
        ...
        values[1] = b;
        values[2] = c;
        assertEq(Operand.unwrap(LibHandleOperand.handleOperand8M1M1(values)), (c << 9) | (b << 8) | a);
    }
